        ...
        <section className="order">
            <div className="container">
                ...
                <form className="order__form">
                    ...
                    <input type="text" className="order__input order__input-address" name="address"
                           placeholder="Адрес" value={orderDetails.address} onChange={handleChange}/>
                    <fieldset className="order__payment">
                        <h3 className="order__payment-title">
                            Оплата
                        </h3>
